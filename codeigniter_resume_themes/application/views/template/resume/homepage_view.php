...
<head>
	...
	<!-- Bootstrap core CSS -->
	<link href="{base_url}assets/themes/resume/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

	<!-- Custom fonts for this template -->
	<link href="https://fonts.googleapis.com/css?family=Saira+Extra+Condensed:500,700" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css?family=Muli:400,400i,800,800i" rel="stylesheet">
	<link href="{base_url}assets/themes/resume/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">

	<!-- Custom styles for this template -->
	<link href="{base_url}assets/themes/resume/css/resume.min.css" rel="stylesheet">
...
<body id="page-top">
	...
	<script src="{base_url}assets/themes/resume/vendor/jquery/jquery.min.js"></script>
	<script src="{base_url}assets/themes/resume/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

	<!-- Plugin JavaScript -->
	<script src="{base_url}assets/themes/resume/vendor/jquery-easing/jquery.easing.min.js"></script>

	<!-- Custom scripts for this template -->
	<script src="{base_url}assets/themes/resume/js/resume.min.js"></script>
