...
<head>
	...
	<!-- Bootstrap core CSS -->
	<link href="{base_url}assets/themes/agency/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

	<!-- Custom fonts for this template -->
	<link href="{base_url}assets/themes/agency/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
	...
	<link href="{base_url}assets/themes/agency/css/agency.min.css" rel="stylesheet">
...
<body id="page-top">
	...
	<script src="{base_url}assets/themes/agency/vendor/jquery/jquery.min.js"></script>
	<script src="{base_url}assets/themes/agency/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

	<!-- Plugin JavaScript -->
	<script src="{base_url}assets/themes/agency/vendor/jquery-easing/jquery.easing.min.js"></script>

	<!-- Contact form JavaScript -->
	<script src="{base_url}assets/themes/agency/js/jqBootstrapValidation.js"></script>
	<script src="{base_url}assets/themes/agency/js/contact_me.js"></script>

	<!-- Custom scripts for this template -->
	<script src="{base_url}assets/themes/agency/js/agency.min.js"></script>
